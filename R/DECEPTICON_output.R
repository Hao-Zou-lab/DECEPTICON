...
#'@export
DECEPTICON_output <- function(path, light = FALSE){
  setwd(path)
  #cibersort
  res1 = read.table('./ciber_ciber.txt',header = T, sep = "\t", row.names = 1)
  res4 = read.table('./ciber_quan.txt',header = T, sep = "\t", row.names = 1)
  res5 = read.table('./ciber_immu.txt',header = T, sep = "\t", row.names = 1)
  if(light == FALSE){
    res2 = read.table('./ciber_TRef.txt',header = T, sep = "\t", row.names = 1)
    res3 = read.table('./ciber_BRef.txt',header = T, sep = "\t", row.names = 1)
  }



  #epic
  res6 = read.table('./EPIC_ciber.txt',header = T, sep = "\t", row.names = 1)
  res7 = read.table('./EPIC_TRef.txt',header = T, sep = "\t", row.names = 1)
  res8 = read.table('./EPIC_BRef.txt',header = T, sep = "\t", row.names = 1)
  res9 = read.table('./EPIC_quan.txt',header = T, sep = "\t", row.names = 1)
  res10 = read.table('./EPIC_immu.txt',header = T, sep = "\t", row.names = 1)

  #mcp
  res11 = read.table('./MCP_ciber.txt',header = T, sep = "\t", row.names = 1)
  res12 = read.table('./MCP_TRef.txt',header = T, sep = "\t", row.names = 1)
  res13 = read.table('./MCP_BRef.txt',header = T, sep = "\t", row.names = 1)
  res14 = read.table('./MCP_quan.txt',header = T, sep = "\t", row.names = 1)
  res15 = read.table('./MCP_immu.txt',header = T, sep = "\t", row.names = 1)

  #quanTlseq
  res16 = read.table('./quan_ciber.txt',header = T, sep = "\t", row.names = 1)
  res17 = read.table('./quan_TRef.txt',header = T, sep = "\t", row.names = 1)
  res18 = read.table('./quan_BRef.txt',header = T, sep = "\t", row.names = 1)
  res19 = read.table('./quan_quan.txt',header = T, sep = "\t", row.names = 1)
  res20 = read.table('./quan_immu.txt',header = T, sep = "\t", row.names = 1)

  #deconRNAseq
  res21 = read.table('./Decon_ciber.txt',header = T, sep = "\t", row.names = 1)
  res22 = read.table('./Decon_TRef.txt',header = T, sep = "\t", row.names = 1)
  res23 = read.table('./Decon_BRef.txt',header = T, sep = "\t", row.names = 1)
  res24 = read.table('./Decon_quan.txt',header = T, sep = "\t", row.names = 1)
  res25 = read.table('./Decon_immu.txt',header = T, sep = "\t", row.names = 1)

  #cibersort_abs
  res26 = read.table('./ciber_abs_ciber.txt',header = T, sep = "\t", row.names = 1)
  res29 = read.table('./ciber_abs_quan.txt',header = T, sep = "\t", row.names = 1)
  res30 = read.table('./ciber_abs_immu.txt',header = T, sep = "\t", row.names = 1)
  if(light == FALSE){
    res27 = read.table('./ciber_abs_TRef.txt',header = T, sep = "\t", row.names = 1)
    res28 = read.table('./ciber_abs_BRef.txt',header = T, sep = "\t", row.names = 1)
  }



  #scdc
  res31 = read.table('./scdc_ciber.txt',header = T, sep = "\t", row.names = 1)
  res32 = read.table('./scdc_TRef.txt',header = T, sep = "\t", row.names = 1)
  res33 = read.table('./scdc_BRef.txt',header = T, sep = "\t", row.names = 1)
  res34 = read.table('./scdc_quan.txt',header = T, sep = "\t", row.names = 1)
  res35 = read.table('./scdc_immu.txt',header = T, sep = "\t", row.names = 1)

  #music
  if(package.version("MuSiC") == c("0.2.0")){
  res36 = read.table('./music_ciber.txt',header = T, sep = "\t", row.names = 1)
  res37 = read.table('./music_TRef.txt',header = T, sep = "\t", row.names = 1)
  res38 = read.table('./music_BRef.txt',header = T, sep = "\t", row.names = 1)
  res39 = read.table('./music_quan.txt',header = T, sep = "\t", row.names = 1)
  res40 = read.table('./music_immu.txt',header = T, sep = "\t", row.names = 1)
  }

  #bseq-sc
  res41 = read.table('./bseq_ciber.txt',header = T, sep = "\t", row.names = 1)
  res42 = read.table('./bseq_TRef.txt',header = T, sep = "\t", row.names = 1)
  res43 = read.table('./bseq_BRef.txt',header = T, sep = "\t", row.names = 1)
  res44 = read.table('./bseq_quan.txt',header = T, sep = "\t", row.names = 1)
  res45 = read.table('./bseq_immu.txt',header = T, sep = "\t", row.names = 1)

  if(light == FALSE){
    #batman
    res46 = data.frame(t(read.table('./batman_ciber.txt',header = T, sep = "\t", row.names = 1)))
    res47 = data.frame(t(read.table('./batman_TRef.txt',header = T, sep = "\t", row.names = 1)))
    res48 = data.frame(t(read.table('./batman_BRef.txt',header = T, sep = "\t", row.names = 1)))
    res49 = data.frame(t(read.table('./batman_quan.txt',header = T, sep = "\t", row.names = 1)))
    res50 = data.frame(t(read.table('./batman_immu.txt',header = T, sep = "\t", row.names = 1)))
  }
  ...
  #choose
    ...
    if(light == FALSE){
      ...
      } else  if(package.version("MuSiC") == c("0.2.0")){
  ...
  library(vegan)
  library(psych)
  res11 = decostand(res11,MARGIN = 1,"total")
  res12 = decostand(res12,MARGIN = 1,"total")
  res13 = decostand(res13,MARGIN = 1,"total")
  res14 = decostand(res14,MARGIN = 1,"total")
  res15 = decostand(res15,MARGIN = 1,"total")
  if(light == FALSE){
    res46 = decostand(res46,MARGIN = 1,"total")
    res47 = decostand(res47,MARGIN = 1,"total")
    res48 = decostand(res48,MARGIN = 1,"total")
    res49 = decostand(res49,MARGIN = 1,"total")
    res50 = decostand(res50,MARGIN = 1,"total")
  }
  #B cell
  if(light == FALSE){
    if(package.version("MuSiC") == c("0.2.0")){
...
#'@export
run_DECEPTICON <- function(bulk.samples, RUNpath, path, light = FALSE, custom.signature = FALSE, signature.matrix = NULL){
