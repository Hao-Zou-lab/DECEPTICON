...
mapGenes<-function(mydata) {
  ...
  HGNC<-read.csv("D:/projects/6-deconvolution/反卷积-SOP/quanTlseq/quanTlseq数据、文件及代码/HGNC_genenames_20170418.txt", header=TRUE, sep="\t")
...
celldensities <- function(DCres){
  ...
  imageinfo <- read.csv("D:/projects/6-deconvolution/反卷积-SOP/quanTlseq/quanTlseq数据、文件及代码/totalcells.txt", header=FALSE, sep="\t", stringsAsFactors = FALSE)
